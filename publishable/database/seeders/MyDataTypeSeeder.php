...
class MyDataTypeSeeder extends Seeder
{
 ...
 "scope":null
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerCgyController',
            'description'           => '分類表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerCommentController',
            'description'           => '留言表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerContactController',
            'description'           => '聯絡單表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerPartnerController',
            'description'           => '合作夥伴表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerSerialController',
            'description'           => '序號表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
            'details'               => '{"order_column":null,"order_display_column":null,"order_direction":"asc","default_search_key":null,"scope":null}',
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerTagController',
            'description'           => '標籤表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
            'details'               => '{"order_column":"sort","order_display_column":"title","order_direction":"asc","default_search_key":"sort","scope":null}',
        ...
        DataType::create([
            ...
            'policy_name'           => null,
            'controller'            => '\\Javck\\Ezlaravel\\Http\\Controllers\\MyVoyagerOrderController',
            'description'           => '訂單表格',
            'generate_permissions'  => 1,
            'server_side'           => 1,
            'details'               => '{"order_column":null,"order_display_column":null,"order_direction":"asc","default_search_key":null,"scope":null}',
