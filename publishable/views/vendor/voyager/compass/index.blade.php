    ...
    <div class="page-content compass container-fluid">
        <ul class="nav nav-tabs">
          @if (Auth::user()->role->name == 'super')
            ...
            <li @if($active_tab == 'developer'){!! 'class="active"' !!}@endif><a data-toggle="tab" href="#developer"><i class="voyager-cup"></i> {{ __('voyager::generic.developer_guide') }}</a></li>
          @endif
          <li @if($active_tab == 'tutorials'){!! 'class="active"' !!}@endif><a data-toggle="tab" href="#tutorials"><i class="voyager-study"></i> {{ __('voyager::compass.tutorials.title') }}</a></li>
          <li @if($active_tab == 'canvas'){!! 'class="active"' !!}@endif><a data-toggle="tab" href="#canvas"><i class="voyager-brush"></i> {{ __('voyager::generic.canvas_guide') }}</a></li>   
        </ul>

        <div class="tab-content">
            <div id="resources" class="tab-pane fade in @if((isset($active_tab) && $active_tab == 'resources')){!! 'active' !!}@endif">
          ...
          <div id="tutorials" class="tab-pane fade in @if(empty($active_tab) || (isset($active_tab) && $active_tab == 'tutorials')){!! 'active' !!}@endif">
            <div class="row">

                @include('voyager::compass.includes.tutorials')
          ...
          <div id="developer" class="tab-pane fade in @if($active_tab == 'developer'){!! 'active' !!}@endif">
            <h3><i class="voyager-cup"></i> {{ __('voyager::generic.developer_guide') }} <small>{{ __('voyager::generic.developer_desc') }}，<a href="http://easyweb.test/Documentation/" target="_blank">閱讀完整文件</a>。</small></h3>

            <div class="row">
                @include('voyager::compass.includes.developer')
            </div>
          </div>
          <div id="canvas" class="tab-pane fade in @if($active_tab == 'canvas'){!! 'active' !!}@endif">
            <h3><i class="voyager-brush"></i> {{ __('voyager::generic.canvas_guide') }} <small>{{ __('voyager::generic.canvas_desc') }}</small></h3>
            <div class="row">
                @include('voyager::compass.includes.canvas')
            </div>
          </div>
        </div>
