    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                @php
                $segments = array_filter(explode('/', str_replace('admin', '', Request::path())));
                ...
                @else
                    ...
                    @foreach ($segments as $segment)
                        @php
                        $url .= '/'.$segment;
                        $type = DB::table('data_types')->where('slug',$segment)->first();
                        if(isset($type)){
                            $text = ucwords(str_replace('-', ' ', $type->display_name_plural));
                        }elseif(in_array($segment,['edit','create','compass'])){
                            $text = __($segment);
                        }else{
