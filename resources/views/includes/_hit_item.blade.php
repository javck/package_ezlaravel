		...
		<div class="row clearfix">
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="featured-item topmargin">
					...
					<div href="{{url('api/items/show?item_id='.$item->id)}}" class="button button-border button-circle nomargin font-secondary item-quick-view" id="more"  data-lightbox="ajax">了解更多</div>
				</div>
			</div>
		</div>
	</div>
