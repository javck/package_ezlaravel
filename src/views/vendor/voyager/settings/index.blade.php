                ...
                <div class="page-content settings container-fluid">
                    ...
                    <ul class="nav nav-tabs">
                        @foreach($settings as $group => $setting)
                            <li 
                                @if($group == $active) 
                                    class="active" 
                                @elseif(Auth::user()->role->name != 'super' && $group != 'Site')
                                    class="hide"
                                @endif>
                    ...
                    <div class="tab-content">
                        @foreach($settings as $group => $group_settings)
                            @php
                                if(Auth::user()->role->name != 'super' && $group != 'Site'){
                                    $isHide = "hide";
                                }else{
                                    $isHide = "";
                                }
                            @endphp
                        <div id="{{ \Illuminate\Support\Str::slug($group) }}" class="tab-pane fade in @if($group == $active) active @endif {{ $isHide }}">
